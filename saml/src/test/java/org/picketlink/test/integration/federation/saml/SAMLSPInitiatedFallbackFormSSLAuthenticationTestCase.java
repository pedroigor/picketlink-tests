...
@RunAsClient
public class SAMLSPInitiatedFallbackFormSSLAuthenticationTestCase extends AbstractFederationTestCase {
    ...
    public static WebArchive deployServiceProvider() {
        return resolveFromFederation("picketlink-federation-saml-sp-post-with-ssl");
    }
