...
@RunAsClient
public class SAMLBackChannelGlobalLogoutWithEncryptionProfileTestCase extends AbstractFederationTestCase {
    ...
    public static WebArchive deployIdp() {
        ...
        deployment.add(getIdPConfig(null, true, true, null, null, true), "WEB-INF/picketlink.xml");
    ...
    public static WebArchive deployEmployee() {
        ...
        deployment.add(getSpConfig(null, "http://localhost:8080/employee/", true, true), "WEB-INF/picketlink.xml");
        deployment.addAsResource(AbstractFederationTestCase.class.getResource("/config/jbid_test_keystore.jks"), "/jbid_test_keystore.jks");
    ...
    public static WebArchive deploySales() {
        ...
        deployment.add(getSpConfig(null, "http://localhost:8080/sales-post/", true, true), "WEB-INF/picketlink.xml");
        deployment.addAsResource(AbstractFederationTestCase.class.getResource("/config/jbid_test_keystore.jks"), "/jbid_test_keystore.jks");
