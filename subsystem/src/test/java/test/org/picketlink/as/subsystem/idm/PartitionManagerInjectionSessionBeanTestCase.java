...
public class PartitionManagerInjectionSessionBeanTestCase {
    ...
    public static WebArchive deploy() {
        WebArchive deployment = ShrinkWrap
            ...
            .addClass(PartitionManagerInjectionSessionBeanTestCase.class)
    ...
    public void testInjection() throws Exception {
        ...
        if (partition == null) {
            this.sessionScopedBean.createDefaultPartition();
        }

        partition = this.sessionScopedBean.getDefaultPartition();
