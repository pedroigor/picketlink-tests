...
public class LDAPBasedPartitionManagerTestCase {
    ...
    public static WebArchive createDeployment() {
        WebArchive deployment = ShrinkWrap
                                        ...
                                        .addAsManifestResource(LDAPBasedPartitionManagerTestCase.class.getClassLoader().getResource("deployment/jboss-deployment-structure-idm-simple-schema.xml"), "jboss-deployment-structure.xml")
