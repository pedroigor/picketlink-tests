...
public class PartitionManagerInjectionConversationBeanTestCase extends AbstractJPADeploymentTestCase {
    ...
    public static WebArchive deploy() {
        return deploy(PartitionManagerInjectionConversationBeanTestCase.class, ConversationScopedBean.class);
    }
    ...
    public void testInjection() throws Exception {
        ...
        Conversation conversation = this.conversationScopedBean.getConversation();
